...
% openany document: collapse \cleardoublepage to \clearpage so the
% template's TOC/LOF/LOT macros do not force blank verso pages.
...
% Use the scanned A4 verification letter while preserving roman page label i.
\clearpage
\phantomsection
\pagenumbering{roman}
\addcontentsline{toc}{chapter}{Verification Letter from the Oral Examination Committee}
\includepdf[
  pages=1,
  pagecommand={\thispagestyle{plain}}
]{front/verification-letter.pdf}

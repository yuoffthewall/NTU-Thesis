...
Computing Environments},
  ...
  DOI           = {10.6342/NTU202601059},
  keywords      = {WebAssembly, 及時編譯, 分層編譯, 在堆疊替換, 邊緣運算, WasmEdge},
...
\usepackage{pgfplots}                   % bar charts for evaluation figures
\pgfplotsset{compat=1.18}
\definecolor{stepone}{HTML}{A0CBE8}     % Step 1 bars (light blue)
\definecolor{steptwo}{HTML}{4E79A7}     % Step 2 bars (blue)
\definecolor{stepthree}{HTML}{59A14F}   % Step 3 bars (green)
